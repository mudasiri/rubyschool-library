...
describe Student do
  describe '#initialize' do
    before :each do
      @student = Student.new(17, 'Ali Baba', parent_permission: true)
    end
    ...
    it 'inherits the name attribute from Person' do
      ...
      expect(@student).to have_attributes(name: 'Ali Baba')
  ...
  describe '#to_json' do
    ...
    it 'returns a hash of the student\'s attributes' do
      expected_output = { 'id' => @student.id, 'name' => 'Ali Baba', 'age' => 17, 'parent_permission' => true,
                          'class' => 'Student' }
